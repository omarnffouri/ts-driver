...
import com.transport_system.ts_driver.databinding.GroupVideoCallItemViewBinding
import com.transport_system.ts_driver.helpers.AppLogger

class GroupVideoCallUserAdapter(private val callUser: ArrayList<CallUser>) : RecyclerView.Adapter<GroupVideoCallUserAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        return ItemViewHolder(GroupVideoCallItemViewBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
...
//                    holder.binding.userVideoView.addView(surfaceView)
    ...
    class ItemViewHolder(val binding: GroupVideoCallItemViewBinding) : ViewHolder(binding.root) , LifecycleOwner {
