...
class CallUserBusyEvent private constructor(private val context: Context) : PusherPrivateChannelEventListener() {
    ...
    override fun onSubscriptionSucceeded(channelName: String?) {
        AppLogger.log("Call user busy event subscription succeeded on channel : $channelName")
    }

    override fun onAuthenticationFailure(message: String?, e: java.lang.Exception?) {
        AppLogger.log("Call user busy event authentication failed ===> message : $message, exception : ${e?.message}")
    }
}