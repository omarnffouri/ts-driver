...
class SettlementInfoWidget extends GetView<PartnerSettlementDetailsController> {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildRow(
            context,
            'Reimbursements:',
            '${controller.settlemetDetails.value.reimbursements}',
          ),
          const SizedBox(height: 8.0),
          _buildRow(
            context,
            'Deductions:',
            '${controller.settlemetDetails.value.deductions}',
          ),
