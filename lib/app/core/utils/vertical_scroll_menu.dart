...
class VerticalScrollMenu extends StatefulWidget {
...
class _CupertinoPickerState extends State<VerticalScrollMenu> {
  ...
  @override
  void didUpdateWidget(VerticalScrollMenu oldWidget) {
