...
class MatchTargetItem {
  ...
  final TextStyle? regixCharStyle;
  //
  ...
  MatchTargetItem({
    ...
    this.allowInlineMatching = false,
            ...
            (text == null && regex != null) || (text != null && regex == null),
  ...
  bool operator ==(covariant MatchTargetItem other) {
    ...
    return other.text == text &&
        ...
        other.regixCharStyle == regixCharStyle;
  }
